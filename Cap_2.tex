...
En el área de aprendizaje profundo también se ha hecho progreso. Particularmente en \cite{luo2017deep} se hace uso de una \ac{DBN} que se compara con algoritmos más populares de puntuación de crédito como \ac{LR}, \ac{MLP} y \ac{SVM}. Los modelos son aplicados en un dataset de contratos CDS XR 14 (sin reestructuración) y los resultados arrojan que la \ac{DBN} tiene la mejor accuracy y AUC.

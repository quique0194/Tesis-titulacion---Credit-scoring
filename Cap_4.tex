...
Finalmente, el \ac{ECDD} de Decision Tree obtiene resultados muy buenos consistentemente en Lending Club y el Crédito Alemán, lo que sugiere que si los datos no son linealmente separables, entonces este modelo tiene un gran poder predictivo. Probando una vez más que usar el Decision Tree como base para algoritmos de ensamble tiene muy buenos resultados.

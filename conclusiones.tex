...
Hemos visto que en el área de puntuación crediticia hay abundante investigación, pero que no se ha explotado lo suficiente características del dataset crediticio típico, como el desbalanceo de los datos, el cuál se trato de explotar en este trabajo para obtener los mejores resultados posibles.
